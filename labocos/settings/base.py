...
LOCAL_APPS = [
    ...
    'apps.technique.apps.TechniqueConfig',
    'apps.qualite.apps.QualiteConfig',
    'apps.metrologie.apps.MetrologieConfig',
    'apps.rh.apps.RhConfig',
    'apps.achats.apps.AchatsConfig',
    'apps.ged.apps.GedConfig',
    'apps.espace_user.apps.EspaceUserConfig',
    'apps.informatique.apps.InformatiqueConfig',
    'apps.parametrage.apps.ParametrageConfig',
]
